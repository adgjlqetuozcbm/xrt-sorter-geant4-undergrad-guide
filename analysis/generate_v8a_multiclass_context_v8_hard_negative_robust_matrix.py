...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate v8A v8 twenty-material hard-negative robustness matrix.")
    ...
    if config.get("status") != "development_twenty_material_hard_negative_preregistration":
        raise RuntimeError("v8 config must remain development_twenty_material_hard_negative_preregistration.")
                ...
                for pose_value in config["pose_indices"]:
                    ...
                    for count_index, count_config in enumerate(config["count_target_bins"]):
                        ...
                        for perturbation_profile in split_profiles:
                            ...
                            source_id = f"v8a_full20_v8_{perturb_tag}_{energy_tag}"
                            is_hard_negative_profile = "hard_negative" in perturbation["perturbation_family"]
                            for material in materials:
                                ...
                                write_config(
                                    project_root / config_rel,
                                    {
                                        ...
                                        "research_route": "v8a_multiclass_context_twenty_material_hard_negative",
                                        "prediction_stage": "twenty_material_hard_negative_robust",
                                        "run_role": "material",
                                        ...
                                        "hard_negative_profile": is_hard_negative_profile,
                                        "hard_negative_material_focus": material in config["hard_negative_materials"],
                                        ...
                                        "phase_space_profile_version": "v8_twenty_material_hard_negative_robust_v1",
                                    },
                                )
                                rows.append(
                                    {
    ...
    manifest = {
        "generated_by": "analysis/generate_v8a_multiclass_context_v8_hard_negative_robust_matrix.py",
        "config": args.config,
        "profile": profile,
        "development_only": True,
        "shadow_or_final_used": False,
        ...
        "peak_table_id": peak_table_id,
        "materials": materials,
        "hard_negative_materials": config["hard_negative_materials"],
        "rows": len(rows),
