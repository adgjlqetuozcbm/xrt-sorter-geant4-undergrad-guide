...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate v8A v7 twenty-material perturbation-augmented scalability scout matrix.")
    ...
    if config.get("status") != "development_twenty_material_scalability_scout_preregistration":
        raise RuntimeError("v7 config must remain development_twenty_material_scalability_scout_preregistration.")
                ...
                for pose_value in config["pose_indices"]:
                    ...
                    for count_index, count_config in enumerate(config["count_target_bins"]):
                        ...
                        for perturbation_profile in split_profiles:
                            ...
                            source_id = f"v8a_full20_v7_{perturb_tag}_{energy_tag}"
                            for material in materials:
                                ...
                                write_config(
                                    project_root / config_rel,
                                    {
                                        ...
                                        "research_route": "v8a_multiclass_context_twenty_material_scalability",
                                        "prediction_stage": "twenty_material_scalability_scout",
                                        "run_role": "material",
                                        ...
                                        "phase_space_profile_version": "v7_twenty_material_scalability_scout_v1",
                                    },
                                )
                                rows.append(
                                    {
    ...
    manifest = {
        "generated_by": "analysis/generate_v8a_multiclass_context_v7_twenty_material_scalability_scout_matrix.py",
        "config": args.config,
        "profile": profile,
        "development_only": True,
        "shadow_or_final_used": False,
